plot(elisa$conc, elisa$a2)
plot(elisa$conc, elisa$a2, pch = 21, bg = 'black', ylab = 'intensity', xlab = 'concentration')
#create grids
grid()
#plotting the log of concentration
plot(log(elisa$conc), elisa$a2, pch = 21, bg = 'black', ylab = 'intensity', xlab = 'log(concentration)')
#make title
grid()
title('kims elisa elisa data',outer = T)
par(mfrow = c(1, 1))
